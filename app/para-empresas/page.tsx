                ...
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <motion.div key={i} variants={fadeIn} className="flex gap-4 p-6 rounded-2xl border border-slate-200 bg-white hover:border-slate-300 hover:shadow-lg transition-all group">
            ...
            <section className="py-24 bg-white">
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
                        ...
                        <motion.p variants={fadeIn} className="text-lg text-slate-500 max-w-xl mx-auto">
                            Registra tu empresa, publica tu primera vacante y deja que la IA trabaje por ti.
                        </motion.p>
                    </motion.div>

                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid md:grid-cols-3 gap-8">
                        {[
                            { step: "01", icon: Building2, title: "Registra tu empresa", desc: "Crea tu cuenta empresarial en menos de 2 minutos. Completa tu perfil con información de tu organización.", color: "from-blue-500 to-blue-600" },
                            { step: "02", icon: Briefcase, title: "Publica tus vacantes", desc: "Crea publicaciones detalladas con perfiles ideales. Nuestra IA te ayudará a optimizar cada publicación.", color: "from-indigo-500 to-purple-600" },
                            { step: "03", icon: Bot, title: "Entrevistas con IA", desc: "Los candidatos realizan entrevistas con avatares IA 24/7. Recibe evaluaciones automáticas con scoring.", color: "from-emerald-500 to-teal-600" },
                        ].map((item, i) => (
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link href="#">
                                <Button className="h-14 px-8 text-base font-semibold rounded-xl bg-slate-50 border border-slate-200 text-slate-700 hover:bg-slate-100 transition-all">
